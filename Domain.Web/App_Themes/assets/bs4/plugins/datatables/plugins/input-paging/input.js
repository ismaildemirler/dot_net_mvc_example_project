...
(function ($) {
    ...
    $.fn.dataTableExt.oPagination.input = {
        'fnInit': function (oSettings, nPaging, fnCallbackDraw) {
            ...
            nFirst.innerHTML = "<i class='fa fa-step-backward'></i>";
            nPrevious.innerHTML = "<i class='fa fa-backward'></i>";;
            nNext.innerHTML = "<i class='fa fa fa-forward'></i>";
            nLast.innerHTML = "<i class='fa fa-step-forward'></i>";;
