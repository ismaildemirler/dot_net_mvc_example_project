...
var mLayout = function () {
    ...
    var initLeftAsideToggle = function () {
        var asideLeftToggle = $('#m_aside_left_minimize_toggle').mToggle({
            ...
            var a1 = $("#menuTabUl li:nth-child(1) a");
            var a2 = $("#menuTabUl li:nth-child(2) a");

            var tab1 = $("#menuTabContainer .tab-pane:nth-child(1)");
            var tab2 = $("#menuTabContainer .tab-pane:nth-child(2)");
            ...
            if (state == "on") {
                ...
                a1.addClass("active show");
                a2.removeClass("active show");
